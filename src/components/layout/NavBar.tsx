        ...
        <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`} id="navbar">
            <div className="container nav-container">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginLeft: '0.5rem' }}>
                    ...
                    <a href="https://github.com/truthset-market/reliquex" target="_blank" rel="noopener noreferrer" title="GitHub" style={{ color: '#888', transition: 'color 0.2s' }} onMouseEnter={e => (e.currentTarget.style.color = '#00ff41')} onMouseLeave={e => (e.currentTarget.style.color = '#888')}>
